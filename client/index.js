...
let themeToggle = (active, value, icon, label) => {
    let id = core.UUID();
    return [
        new b.input({
            type: "radio",
...
core.documentReady(() => {
    ...
    core.appendChild(body, new b.row({ paddingY: 5, gap: 3 }, [
        new b.row(new b.col([
            new b.btngroup([
    ...
    core.appendChild(body, new b.row({ paddingY: 5, gap: 3 }, [
        new b.row(new b.col([
            ...
            new b.example.description("Quickly manage the layout, alignment, and sizing of grid columns, navigation, components, and more with a full suite of responsive flexbox utilities. For more complex implementations, custom CSS may be necessary."),
