...
export declare const Tag: (Tag: string, Attr?: IAttr) => tag;
export declare class strHtml {
    ishtml: boolean;
    elem?: string;
    constructor();
    constructor(elem: string);
}
export declare const StrHtml: (Html: string) => strHtml;
export declare const isTag: <T>(obj: any) => obj is T;
export declare const isHtml: <T extends strHtml>(obj: any) => obj is T;
export declare const isAttr: <T>(obj: any) => obj is T;
export declare const tagConsNoElemArg: <T extends IAttr>(arg: any[]) => T;
export declare const tagConsArg: <T extends IAttr>(prop: string, arg: any[]) => T;
export declare const genTagClass: <T extends tag, U>(TagClass: new (...args: any[]) => T, AttrOrElem?: IElem | U | undefined, Elem?: IElem) => T;
