...
import { genDescription, genValidFeedback, genInvalidFeedback, genGroupItem, descriptionSetup, genValidTooltip, genInvalidTooltip, labelFloatingFeedbackManager, } from "../_fn.js";
...
export const Textarea = (attr) => {
    ...
    if (attr.validFeedback || attr.invalidFeedback || attr.validTooltip || attr.invalidTooltip) {
        tAttr = mergeObject({ on: { input: labelFloatingFeedbackManager, invalid: labelFloatingFeedbackManager } }, tAttr);
    }
