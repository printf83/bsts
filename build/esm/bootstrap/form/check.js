...
import { genDescription, genValidFeedback, genInvalidFeedback, descriptionSetup, genInvalidTooltip, genValidTooltip, } from "./_fn.js";
export const Check = (attr) => {
    attr.type ??= "checkbox";
    attr.id ??= UUID();
    attr.label ??= attr.id;
    ...
    //put in container
    if (attr.container) {
        return new div(attr.container, new div(tContainer, [
            tElem,
            tLabel ? tLabel : "",
            tDescription,
            tValidFeedback,
