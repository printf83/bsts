...
import { genLabel, genDescription, genValidFeedback, genInvalidFeedback, genGroupItem, colSetup, descriptionSetup, genInvalidTooltip, genValidTooltip, } from "./_fn.js";
export const Textarea = (attr) => {
    let container = attr.container;
    attr.id ??= UUID();
    attr.describedby = descriptionSetup(attr.id, attr.describedby, attr.description, attr.validFeedback, attr.invalidFeedback, attr.validTooltip, attr.invalidTooltip);
    //setup element
    ...
    let colSetting = colSetup(attr.validFeedback, attr.invalidFeedback, attr.description, attr.col1, attr.col2, attr.col3);
