...
export declare const core: {
    ...
    importJS: typeof importJS;
    importJSPromise: typeof importJSPromise;
    ...
    multiClass: (value: string | number | boolean, rules: import("./base/attachBootstrap").bs.rule) => string[];
    multipleConstructorClass: (rules: import("./fn/multipleConstructorClass").IMultipleConstructor[], caller: string, obj: any[]) => any;
    ...
    html: (arg: string | import("./base/base.interface").IBase | (string | import("./base/base.interface").IBase)[]) => string;
    build: (container: HTMLElement, arg: string | import("./base/base.interface").IBase | (string | import("./base/base.interface").IBase)[], append?: boolean, pos?: HTMLElement) => HTMLElement;
    appendChild: (container: HTMLElement, arg: string | import("./base/base.interface").IBase | (string | import("./base/base.interface").IBase)[]) => HTMLElement;
    prependChild: (container: HTMLElement, arg: string | import("./base/base.interface").IBase | (string | import("./base/base.interface").IBase)[]) => HTMLElement;
    replaceChild: (container: HTMLElement, arg: string | import("./base/base.interface").IBase | (string | import("./base/base.interface").IBase)[]) => HTMLElement;
    replaceWith: (elem: HTMLElement, arg: string | import("./base/base.interface").IBase | (string | import("./base/base.interface").IBase)[]) => HTMLElement;
};
